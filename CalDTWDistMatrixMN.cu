...
{
  // cout << argc << endl;
  if(argc != 7){cout << "usage: ./CalDTWDistMatrixMN -i_M FolderPath1 -i_N FolderPath2 -o Output_file" << endl;
                cout << "-i_M Folder_path1: 'FolderPath' is the folder path of time series, the file in 'FolderPath' must be timeSeries_0.txt, timeSeries_1.txt,...,timeSeries_M.txt. Here, M-1 is the number of time series." << endl;
                cout << "-i_N Folder_path2: 'FolderPath' is the folder path of time series, the file in 'FolderPath' must be timeSeries_0.txt, timeSeries_1.txt,...,timeSeries_N.txt. Here, N-1 is the number of time series." << endl;
    ...
    getTimeSeriesDataWithRootName(dataFolder1, TimeSeriesData1, "timeSeries");
    getTimeSeriesDataWithRootName(dataFolder2, TimeSeriesData2, "timeSeries");

    CalDTWMatrixMN(TimeSeriesData1, TimeSeriesData2, dist_matrix, argv[6]);
